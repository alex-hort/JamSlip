...
struct FollowingJamCardView: View {
    let jam: Jam
    ...
    @State private var isUserPremium = false // ✅ NUEVO: Estado premium del usuario
    ...
    var body: some View {
        content
            ...
            .task {
                ...
                await checkUserPremiumStatus() // ✅ Verificar premium
        ...
        VStack {
            ...
            HStack {
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    // ✅ Fecha + usuario + BADGE VERIFICADO
                    HStack(spacing: 6) {
                        ...
                        HStack(spacing: 3) {
                            ...
                            // ✅ Badge verificado si es premium
                            if isUserPremium {
    ...
    private var profileButton: some View {
        ZStack(alignment: .bottomTrailing) {
            ...
            // Ya sigue (checkmark en lugar de +)
